...
function StandingsPage() {
  ...
  async function loadStandings() {
    // Fetch all profiles, predictions, matches, and settings to compute standings
    ...
    // Filter out admin users by checking user_roles (we can't easily do this client-side, so we show all)
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-foreground">Standings</h2>
        <p className="text-sm text-muted-foreground">See who's leading the prediction challenge</p>
      </div>
